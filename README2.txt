...
- In the future, ListTableInsert and UserTableInsert will be replaced by frontend REST requests.
- Search function will require frontend connection, will be a future implementation (REST requests).
